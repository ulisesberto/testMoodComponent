/*! For license information please see main.073fe5c9.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, n, t) => {
              ...
              b &&
                (Dt &&
                  ...
                  (Bt || "onCompositionStart" !== b
                    ...
                    : ((Zn = "value" in (Gn = l) ? Gn.value : Gn.textContent),
                      (Bt = !0))),
                0 < (g = qr(r, b)).length &&
        ...
        function Bl() {
          if (!Vl && null !== Al) {
            ...
            try {
              ...
              throw (null !== Al && (Al = Al.slice(e + 1)), Ke(Ze, Bl), l);
            } finally {
              (kn = n), (Vl = !1);
            }
          }
        ...
        var Wl = [],
          ...
          Jl = "";
        function Gl(e, n) {
          (Wl[Hl++] = ql), (Wl[Hl++] = Ql), (Ql = e), (ql = n);
        }
        function Zl(e, n, t) {
          (Kl[$l++] = Xl), (Kl[$l++] = Jl), (Kl[$l++] = Yl), (Yl = e);
          var r = Xl;
          e = Jl;
          var l = 32 - on(r) - 1;
          (r &= ~(1 << l)), (t += 1);
        ...
        function na(e) {
          for (; e === Ql; )
            (Ql = Wl[--Hl]), (Wl[Hl] = null), (ql = Wl[--Hl]), (Wl[Hl] = null);
          for (; e === Yl; )
            (Yl = Kl[--$l]),
              (Kl[$l] = null),
              (Jl = Kl[--$l]),
        ...
        function Ya(e) {
          ...
          function m(l, a, u, i) {
            ...
            if (m === u.length) return t(l, f), la && Gl(l, m), s;
            if (null === f) {
              for (; m < u.length; m++)
                null !== (f = d(l, u[m], i)) &&
                  ((a = o(f, a, m)),
        ...
        function ro(e, n) {
          switch ((_l(no, n), _l(eo, e), _l(Za, Ga), (e = n.nodeType))) {
            case 9:
            case 11:
        ...
        var ou = {
          ...
          uu = {
            ...
            useImperativeHandle: function (e, n, t) {
              return (
                (t = null !== t && void 0 !== t ? t.concat([e]) : null),
                jo(4194308, 4, Ko.bind(null, n, e), t)
              );
            },
          ...
          try {
            (Pi.transition = null),
              ...
              (function (e, n, t, r) {
                ...
                if (Qi) throw ((Qi = !1), (e = qi), (qi = null), e);
                0 !== (1 & Xi) && 0 !== e.tag && xs(),
                  (o = e.pendingLanes),
                  0 !== (1 & o)
                    ? e === Gi
  ...
  (() => {
    ...
    const v = (n) => {
        ...
        return (
          (0, e.useEffect)(() => {}, []),
          (0, m.jsx)(h.Provider, { value: { ...r }, children: t })
        );
      },
      g = () => {
        const n = (0, e.useContext)(h),
          [t, r] = (0, e.useState)(!1),
          [l, a] = (0, e.useState)(!0),
          [o, u] = (0, e.useState)("\xbfC\xf3mo te sientes?");
        (0, e.useEffect)(() => {
          i(n.tenantId, n.userId);
        }, []);
        const i = async (e, n) => {
          ("" !== e && null !== e) ||
          ...
          try {
            const t = await fetch(
              "https://dev-api-tutormia.binit.dev/Student/ShowMoodComponent",
              {
                method: "POST",
            ...
            t.ok
              ? r(!0)
              : console.error("Error on check user mood initial config");
            const l = await t.json();
            null != l &&
              (u("\xbfC\xf3mo te sientes hoy?"), r(l.ShowNotificationMood));
          } catch (t) {
            r(!1);
          }
        };
        return {
          sendMood: async (e, n) => {
            try {
              (
                await fetch(
                  "https://dev-api-tutormia.binit.dev/Student/CreateStudentMood",
                  {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
    ...
    const k = { tenantId: "", userId: "" },
              ...
              children: [
                r &&
                  (0, m.jsxs)("div", {
                    className: "card",
                    children: [
                      (0, m.jsx)("h2", { className: "title", children: t }),
                      (0, m.jsx)("div", {
      ...
      S = (n) => {
        ...
        return (
          ...
          t ? (0, m.jsx)(v, { ...t, children: (0, m.jsx)(w, {}) }) : null
        );
      };
    ...
    const x = (function (e) {
      return (function (e, n, t) {
        ...
        const p = (
          ...
          v = {};
        for (const l of p) {
          h[l] = Array.isArray(n.props) ? "string" : n.props[l];
          const e = c(l);
          (m[l] = e), (v[e] = l);
        }
    ...
    })(S, { props: { tenantId: "string", userId: "string" } });
    customElements.define("mood-component", x);
  })();
})();
//# sourceMappingURL=main.073fe5c9.js.map
